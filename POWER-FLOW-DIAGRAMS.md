...
📦 BOX 1 (GFCI)
    ↓ 120V Protected Hot
📦 BOX 2 (VANITY SW 1) ←←←←←←←←←←←←←←←←←← Switched Hot Returns
    ↓ 120V Hot (continues)         ↑
    ...
    │  ⚪ Neutral (direct)         ║                  │
    │                             ║                  ↓
📦 BOX 4 (MAIN SW 1)              ║         📦 BOX 7 (VANITY SW 2)
    ↓ 120V Hot (continues)        ║            VANITY SW 2 (UP Position)
📦 BOX 7 (CONTROL CENTER)         ║            T1 ← Black Traveler
...
📦 BOX 2 (VANITY SW 1)
    ↓ 120V Hot (continues)
📦 BOX 4 (MAIN SW 1) ←←←←←←←←←←←←←←←←←←←← Switched Hot Returns
    ↓ 120V Hot (continues)           ↑
    ...
    │  ⚪ Neutral (direct)           ║                  │
    │                               ║                  ↓
📦 BOX 7 (CONTROL CENTER)           ║         📦 BOX 7 (MAIN SW 2)
...
📍 ELECTRICAL PANEL (15A Breaker - 120V Source)
    ║
    ║ 🔴 Hot (120V) ⚪ Neutral 🟢 Ground
    ↓
📦 BOX 1: GFCI OUTLET
    ║ GFCI Protection Active
    ║ 🔴 Protected Hot ⚪ Protected Neutral 🟢 Ground
    ↓
📦 BOX 2: VANITY SWITCH 1 + POWER HUB
...
📦 BOX 4: MAIN SWITCH 1 + POWER HUB  
    ...
    ↓
📦 BOX 7: CONTROL CENTER (End of Linear Feed)
    ├─ 🔴 Hot (120V) ⚪ Neutral 🟢 Ground
...
Box 2 SW1: COM─UP─T1(Black) ═════════════ T1(Black)─DOWN─○ Box 7 SW2
...
🟢 **Ground Paths**: Complete equipment grounding throughout system  
...
- 🟢 **Ground**: Safety/equipment grounding conductor
